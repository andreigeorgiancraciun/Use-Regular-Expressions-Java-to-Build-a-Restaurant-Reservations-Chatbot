...
public class RestaurantReservationChatBot {
    ...
    public MealTime readMealTime(UserAnswerReader<Boolean> userAnswerReader) {
        ...
        for (MealTime mealTime : MealTime.values()) {
            do {
                System.out.printf("Would you like to make a reservation for %s?%n", mealTime.getMeanTimeValue());
                input = scanner.nextLine();
            } while (userAnswerReader.isValidInput(input));
            if (Boolean.TRUE.equals(userAnswerReader.parseInput(input))) {
                System.out.printf("Great, thank you for choosing to eat %s at our restaurant!%n", mealTime.getMeanTimeValue());
                return mealTime;
            }
        }
        System.out.printf("Unfortunately we only have %s options, please come back later.%n",
    ...
    public int getNumberOfPeople(UserAnswerReader<Integer> userAnswerReader) {
        ...
        System.out.printf("Great! %d is a perfect number for a dinning party at our restaurant.%n", numberOfVisitors);
    ...
    public void registerForPromotions(UserAnswerReader<Boolean> yesNoQuestionReader,
        ...
        if (Boolean.FALSE.equals(yesNoQuestionReader.parseInput(input))) {
        ...
        System.out.printf("Thank you for providing your email %s.%n", email);
    ...
    public void makeReservation(FullNameReader.FullName fullName,
        ...
        System.out.printf("%s %s, phone number: %s%n",
